...
import CustomCalendar.swing.PanelSlide;
...
public class CalendarCustom extends javax.swing.JPanel {
    ...
    private int month;
    private int year;
    private List<CustomClick> fechasToMark;
    private ActionListener action;

    public void setList(List<CustomClick> lista) {
        this.fechasToMark = lista;
        System.out.println(fechasToMark.size());
        slide.show(new PanelDate(month, year, fechasToMark), PanelSlide.AnimateType.TO_LEFT);
        showMonthYear();
    }
    ...
    public CalendarCustom() {
        initComponents();
        thisMonth();
        slide.show(new PanelDate(5, 2021, fechasToMark), PanelSlide.AnimateType.TO_RIGHT);
        showMonthYear();
    ...
    private void initComponents() {
        ...
        slide = new CustomCalendar.swing.PanelSlide();
    ...
    private void cmdBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdBackActionPerformed
        ...
        slide.show(new PanelDate(month, year, fechasToMark), PanelSlide.AnimateType.TO_RIGHT);
        showMonthYear();
    ...
    private CustomCalendar.swing.PanelSlide slide;
